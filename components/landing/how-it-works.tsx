export default function HowItWorks() {
  ...
  return <section id="how-it-works" className="border-b border-white/10 py-24">
    <div className="mx-auto max-w-7xl px-6"><div className="max-w-3xl"><div className="ashqe-mono text-xs text-[#ffffff]">THE LOOP / 02</div><h2 className="ashqe-display mt-4 text-5xl md:text-7xl leading-none">Not a writer.<br/>An operating loop.</h2><p className="mt-6 text-lg leading-8 text-white/55">The product is designed around a continuous loop: observe the world, understand what matters to you, act with intent, then remember what happened.</p></div>
