...
export async function GET(){
 ...
 const tables=["x_connections","style_profiles","drafts","chat_sessions","chat_messages","ashqe_memories","ashqe_jobs","ashqe_job_runs","ashqe_signals","ashqe_content_reviews","ashqe_telegram_connections","ashqe_execution_policy","ashqe_action_log","ashqe_billing_plans","ashqe_payment_intents","ashqe_payment_events","ashqe_subscriptions"]
