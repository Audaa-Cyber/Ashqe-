...
import { getValidAccessToken, fetchRecentTweets, searchRecentTweets } from "@/lib/x/api"
...
export async function POST(){
  ...
  return NextResponse.json({ok:true,posts:tweets.length,discovered:discovered.length})
}
